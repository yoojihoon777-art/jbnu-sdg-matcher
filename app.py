...
if menu == "UN SDG란?":
    ...
    st.markdown(
        ...
        <div class="sdg-research-box">
            <p>
                오늘의 연구는 단순한 학술성과를 넘어 사회문제 해결과 지속가능한 미래를 만드는 데 기여할 수 있습니다. 보건, 에너지, 기후변화, 불평등, 산업혁신 등 다양한 연구주제는 UN 지속가능발전목표(SDGs)와 연결되며, Elsevier/SCOPUS는 논문의 제목·초록·키워드 등을 기반으로 연구성과를 SDG별로 분류합니다.

자신의 연구가 어떤 SDG와 연결되는지 확인하면 연구의 사회적 의미를 보다 명확히 제시할 수 있고, 사회문제 해결형 연구과제, 국제공동연구, 융합연구 등 다양한 연구기회와의 연계 가능성을 탐색하는 데에도 도움이 됩니다.
