...
if menu == "UN SDG란?":
    ...
    st.markdown(
        ...
        <div class="sdg-intro-box">
            ...
            <p class="intro-text">
                ...
                2030년까지 국제사회가 공동으로 해결해야 하는 사회·경제·환경 분야의 17개 목표로 구성됩니다.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    st.markdown(
        ...
        <div class="sdg-research-box">
            <p>
              오늘날 대학의 연구는 단순한 학술성과를 넘어 사회문제 해결과 지속가능한 미래를 만드는 데 기여할 수 있습니다. 보건, 에너지, 기후변화, 불평등, 산업혁신 등 다양한 연구주제가 UN 지속가능발전목표(SDGs)와 연계되며, 국제적 학술 DB인 Elsevier/SCOPUS는 논문의 제목·초록·키워드 등을 기반으로 연구성과가 어떤 SDG와 연계되는지 분류하고 있습니다.

자신의 연구가 어떤 SDG와 연결될 수 있는지 확인한다면, 연구의 사회적 가치와 기여도를 보다 명확하게 제시할 수 있으며, 사회문제 해결형 연구과제·국제공동연구·융합연구 등 다양한 연구 기회와 협력 가능성을 확대하는 데에도 도움이 될 것입니다.

본 시스템을 통해 논문의 SDG 연계 가능성을 사전에 점검하고, 우수한 연구성과가 SDG 연구로 적절히 식별될 수 있도록 확인해보세요.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
