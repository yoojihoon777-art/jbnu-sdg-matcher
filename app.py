...
if menu == "UN SDG란?":
    ...
    st.markdown(
        ...
        <div class="sdg-research-box">
            <p>
              오늘날 대학의 연구는 단순한 학술성과를 넘어 사회문제 해결과 지속가능한 미래를 만드는 데 기여할 수 있습니다.
              우리의 연구는 이미 보건, 에너지, 기후변화, 불평등, 산업혁신 등 UN 지속가능발전목표(SDGs)와 연결되어 있으며, 
              국제적 학술 DB인 Elsevier/SCOPUS 또한 논문의 제목·초록·키워드 등을 기반으로 연구성과가 어떤 SDG와 연계되는지 분류하고 있습니다.
              자신의 연구가 어떤 SDG와 연결될 수 있는지 확인할 수 있다면, 연구의 사회적 가치와 기여도를 보다 명확하게 제시함과 동시에, 
              사회문제 해결형 연구과제·국제공동연구·융합연구 등 다양한 연구 기회를 탐색하는 데에도 도움이 될 것입니다.
